    ...
    <div  className='pt-12 mb-4'>
        ...
        <div className='flex items-center justify-center flex-col' >
            <h1 className='w-40 text-center bg-[#F9D8F4] max-sm:text-[8px] max-sm:w-32 mb-2  py-2 rounded-full text-[14px] font-semibold '>1 Items Added</h1>
             <h1 className='text-3xl font-bold'>Shop By <br /> <span className='text-[#A72564]'>Category</span> </h1>
        ...
        <div className=' w-220 max-sm:w-130 flex items-center justify-center gap-4 overflow-hidden pt-10 '>
            {[0,1,2].map((i)=>{
