...
function SigninForm() {
    let {sign, setSign,handleSignSubmit,handlechange,user, setUser}=useContext(providerContext)
    ...
    <div className=''>
        {
            ...
            <div className='shadow-[0_0_15px_rgba(0,0,0,0.2)] shadow-purple-200 rounded max-sm:flex-col-reverse max-sm:w-full max-sm:px-2 max-sm:mx-3  w-170 px-2 py-2  flex   justify-start max-sm:gap-4 gap-15 '>
                ...
                <form onSubmit={handleSignSubmit}   className='pt-5 max-sm:px-2' >
                    ...
                    <div className=' mb-2'>
                        ...
                        <input name='name' value={sign.name} onChange={handlechange}  type="name" placeholder='Enter name' className='px-2 py-2  text-sm mt-1 border-2  w-full border-gray-200 rounded focus:border-indigo-500  outline-0 transition-all duration-300 '  />
                    </div>
                    <div className=' mb-2'>
                        <h1 className='text-sm max-sm:text-[12px]'>Email: </h1>
                        <input name='email' value={sign.email} onChange={handlechange}  type="email" placeholder='Your@email.com' className='px-2 py-2  text-sm mt-1 border-2  w-full border-gray-200 rounded focus:border-indigo-500  outline-0 transition-all duration-300 '  />
                    </div>
                    <div className='mb-2'>
                        <h1 className='text-sm max-sm:text-[12px]'>Password: </h1>
                        <input name='password' value={sign.password} onChange={handlechange}  type="text" placeholder='Enter Password' className='px-2 py-2    text-sm mt-1 w-full border-2  border-gray-200 rounded focus:border-indigo-500  outline-0 transition-all duration-300 '  />
