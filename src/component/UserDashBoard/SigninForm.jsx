...
function SigninForm() {
  return (
    <div className=''>
                ...
                <div>
                    <form  className='pt-5 max-sm:px-2' >
                    ...
                    <div className=' mb-2'>
                        ...
                        <input name='name'    type="name" placeholder='name' className='px-2 py-2  text-sm mt-1 border-2  w-full border-gray-200 rounded focus:border-indigo-500  outline-0 transition-all duration-300 '  />
                    </div>
                    <div className=' mb-2'>
                        <h1 className='text-sm max-sm:text-[12px]'>Email: </h1>
                        <input name='email'    type="email" placeholder='Your@email.com' className='px-2 py-2  text-sm mt-1 border-2  w-full border-gray-200 rounded focus:border-indigo-500  outline-0 transition-all duration-300 '  />
                    </div>
                    <div className='mb-2'>
                        <h1 className='text-sm max-sm:text-[12px]'>Password: </h1>
                        <input name='password'   type="text" placeholder='Enter Password' className='px-2 py-2    text-sm mt-1 w-full border-2  border-gray-200 rounded focus:border-indigo-500  outline-0 transition-all duration-300 '  />
                    </div>
