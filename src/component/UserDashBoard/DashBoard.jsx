    ...
    <div>
      ...
      <div className='flex items-center justify-between px-10 max-sm:gap-5 max-sm:px-3 max-sm:py-2 py-5'>
        ...
        <div className='flex items-center gap-5 max-sm:gap-3'>
          ...
          <h1 className='text-sm max-sm:text-[10px]'>{user?.name}</h1>
          </div>
          <button onClick={handleClick} className='px-2 py-1 rounded color1 text-white text-sm max-sm:text-[10px]  cursor-pointer'>Log Out</button>
        </div>
      </div>
