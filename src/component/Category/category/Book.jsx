  ...
  return (
    <div >
      <div className='text-center'>
        <h1 className='pt-10 text-3xl max-sm:text-xl  font-semibold'>Category Books </h1>
      </div>
      <div className='pt-5 lg:px-15 max-sm:px-6 md:px-10  flex flex-wrap gap-4  items-center mb-4 justify-center'>
        {fashion.map((elem)=>{
          ...
          <div className='h-60 w-full relative'>
            ...
            <img    className='object-cover h-full cursor-pointer w-full' loading='lazy' decoding="async" src={elem.image} alt="" />
            </Link>
          </div>
